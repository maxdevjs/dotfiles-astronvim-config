...
local config = {
  ...
  mappings = {
    ...
    n = {
      ...
      ['<A-j>'] = { ":m .+1<CR>==", desc = "Normal mode - Move the current line/selection down" },
      -- TODO: fix
    ...
    i = {
      ...
      -- Move current line / block with Alt-j/k à la vscode ⬆️⬇️
      ['<A-j>'] = { "<ESC>:m .+1<CR>==gi", desc = "Insert mode - Move the current line/selection down" },
      ['<A-k>'] = { "<ESC>:m .-2<CR>==gi", desc = "Insert mode - Move the current line/selection up" },

      -- Control + a to select all file
      ['<C-a>'] = { "<Esc>ggVG", desc = "Control + a to select all file" },

      -- Undo break points ⛏️
      ['.'] = { ".<C-G>u", desc = "Set break point" },
      [':'] = { ":<C-G>u", desc = "Set break point" },
      [';'] = { ";<C-G>u", desc = "Set break point" },
      ['!'] = { "!<C-G>u", desc = "Set break point" },
      ['?'] = { "?<C-G>u", desc = "Set break point" },
